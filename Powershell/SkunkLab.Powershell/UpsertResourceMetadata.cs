...
{
    [Cmdlet(VerbsCommon.Set, "ResourceMetadata")]
    public class UpsertResourceMetadata : Cmdlet
    {
        ...
        {
            string url = String.Format("{0}/api2/resourcemetadata", this.ServiceUrl);
            RestRequestBuilder builder = new RestRequestBuilder("POST", url, RestConstants.ContentType.Json, true, this.SecurityToken);
            ...
            request.Post<ResourceMetadata>(metadata);
        }
    }
}
