...
msbuild Piraeus.Core.csproj /t:Rebuild /p:Configuration=Debug
...
msbuild Piraeus.GrainInterfaces.csproj /t:Rebuild /p:Configuration=Debug
...
msbuild Piraeus.Grains.csproj /t:Rebuild /p:Configuration=Debug
...
msbuild SkunkLab.Storage.sln /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild SkunkLab.Diagnostics.sln /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild .\SkunkLab.Security\SkunkLab.Security.csproj /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild .\SkunkLab.Channels\SkunkLab.Channels.csproj /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild .\SkunkLab.Protocols\SkunkLab.Protocols.csproj /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild Piraeus.Configuration.csproj /t:Clean,Rebuild /p:Configuration=Debug
...
msbuild Piraeus.Module.csproj /t:Clean,Rebuild /p:Configuration=Debug
