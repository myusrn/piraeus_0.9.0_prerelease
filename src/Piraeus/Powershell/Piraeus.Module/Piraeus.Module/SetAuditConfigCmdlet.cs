...
{
    [Cmdlet(VerbsCommon.Add, "AuditConfig")]
    public class SetAuditConfigCmdlet : Cmdlet
    {
        ...
        {
            string url = String.Format("{0}/api2/service/ConfigureAudit?table={1}&connectionstring={2}", ServiceUrl, TableName, Connectionstring);
